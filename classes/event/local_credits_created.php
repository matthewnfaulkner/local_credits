...
/**
 * The local_credit_created event class.
 *
 ...
 */
class local_credits_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcreditcreated', 'credits');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created the credit with id '$this->objectid'.";
    }
